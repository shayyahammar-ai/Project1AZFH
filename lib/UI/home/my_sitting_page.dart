...
import 'package:project_azfh/UI/my_health/my_health.dart';
...
class MySittingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('My Sitting')),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Clinical Sanctuary is a premium health management ecosystem designed to bridge the gap between high-level clinical data and patient-centered care through an elite user interface.',
                    ),
                  ),
